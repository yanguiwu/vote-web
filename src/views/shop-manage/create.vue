  ...
  <div>
    <el-card>
      ...
      <el-form ref='ruleForm' :model='formData' label-width='160px' :rules='formRules'>
        ...
        <el-form-item label='商户高级账号名称' prop='userName'>
          <el-input v-model='formData.userName' size='small' placeholder='店铺名称' style='width: 50%;' />
        </el-form-item>
        <el-form-item label='商户高级账号密码' prop='userPassword'>
...
import { createStore } from '/@/api/shop'
...
export default defineComponent({
  ...
  setup() {
    ...
    const formRules = {
      ...
      userName: [
        { required: true, message: '请输入商户高级账号名称', trigger: 'blur' },
        {
          max: 40,
          message: '长度不超过40',
          trigger: 'blur'
      ...
      userPassword: [
        { required: true, message: '请输入商户高级账号密码', trigger: 'blur' },
        {
          max: 40,
          message: '长度不超过40',
          trigger: 'blur'
