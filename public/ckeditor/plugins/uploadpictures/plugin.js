CKEDITOR.plugins.add("uploadpictures", {
  ...
  init: function(editor) {
    CKEDITOR.dialog.add(
      "uploadpictures",
      this.path + "dialogs/uploadpictures.js"
    );
    editor.addCommand(
      "uploadpictures",
      new CKEDITOR.dialogCommand("uploadpictures")
    );
    ...
    CKEDITOR.scriptLoader.load(
      CKEDITOR.getUrl("plugins/uploadpictures/webuploader/webuploader.js")
    );
    CKEDITOR.scriptLoader.load(
      CKEDITOR.getUrl("plugins/uploadpictures/webuploader/filesize.js")
    );
