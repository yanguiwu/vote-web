...
CKEDITOR.editorConfig = function(config) {
  ...
  config.extraPlugins =
    "questionblank,smiley,table,font,kityformula,codesnippet,uploadpictures,shortUrl,image2,colorbutton,colordialog,justify,flash,find,filebrowser";
  ...
  config.smiley_path = getUrlRelativePath(
